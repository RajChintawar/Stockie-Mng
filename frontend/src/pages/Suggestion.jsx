...
export default function Suggestion() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 text-white max-w-4xl mx-auto space-y-8">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">AI Portfolio Analysis</h2>

      <button
        onClick={getSuggestion}
        className="w-full sm:w-auto bg-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition shadow-lg"
      >
        Get AI Suggestion
      </button>
      ...
      {loading && (
        <div className="mt-6 flex flex-col items-center gap-4">
          ...
          <p className="text-gray-400">Analyzing your portfolio… hold on clown 😭🔥</p>
        </div>
      )}

      {!loading && suggestion && (
        <div className="mt-6 p-4 sm:p-6 md:p-8 rounded-2xl 
          ...
          <div className="text-gray-300 whitespace-pre-line leading-relaxed text-sm sm:text-base md:text-lg">
            {suggestion}
          </div>
